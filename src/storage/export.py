...
class MarkdownExporter:
    ...
    def export_single(
        self, job: Dict[str, Any], assessment: Dict[str, Any], output_file: Optional[str] = None
    ) -> Path:
        """
    ...
    def export_report(
        self, assessments: List[Dict[str, Any]], output_file: str = "report.md"
    ) -> Path:
        """
    ...
    def _generate_markdown(self, job: Dict[str, Any], assessment: Dict[str, Any]) -> str:
        """
    ...
    def _generate_summary_section(self, assessments: List[Dict[str, Any]]) -> str:
...
class JSONExporter:
    ...
    def export(
        self, assessments: List[Dict[str, Any]], output_file: str = "assessments.json"
    ) -> Path:
        """
